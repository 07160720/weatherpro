//GkMm4Y7UTFDsEdaGXPUSdKmpkxpqlh6e
...
function init() {
  try {
    var BMap = new bmap.BMapWX({
      ak: 'GkMm4Y7UTFDsEdaGXPUSdKmpkxpqlh6e'
    });
...
function iconChanger(zhText) {
  ...
  if (zhText.indexOf('沙') >= 0) {
    statuData.wall = "/images/sandday";
  } else if (zhText.indexOf('雪') >= 0) {
    statuData.wall = "/images/snow" + wallPaper;
  } else if (zhText.indexOf('雨') >= 0) {
    statuData.wall = "/images/rainy" + wallPaper;
  } else if (zhText.indexOf('云') >= 0) {
    statuData.wall = "/images/cloud" + wallPaper;
  } else {
    statuData.wall = "/images/clear" + wallPaper;
  }
  statuData.icon = zhText;
  return statuData;
}
